...
import '../../pages/UserPage/tools_page.dart';
import '../../pages/UserPage/user_info_page.dart';
import '../../pages/UserPage/setting_page.dart';

// 用户页面的五个按钮, 参数 btnChoose 的值取0~4对应了5个不同按钮, 无参数使用 1/2/4
